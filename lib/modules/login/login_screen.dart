...
import 'package:trello_challenge/modules/login/components/textfield_dialog.dart';
...
class LoginScreen extends GetView<LoginController> {
        ...
        children: [
          ...
          Padding(
            ...
            child: Align(
              ...
              child: InkWell(
                onTap: () {
                  _showTextFieldDialog(VerifyEmailType.forgot);
                },
                child: Text(
                  'Quên mật khẩu?',
                  style: TextStyle(
          ...
          const Gap(130),
          Padding(
            padding: const EdgeInsets.only(right: 23, top: 20, bottom: 10),
            child: Align(
              alignment: Alignment.center,
              child: InkWell(
                onTap: () {
                  _showTextFieldDialog(VerifyEmailType.active);
                },
                child: Text(
                  'Xác thực tài khoản',
                  style: TextStyle(
  ...
  _showTextFieldDialog(VerifyEmailType verifyEmailType) {
    Get.dialog(TextFieldDialog(verifyEmailType: verifyEmailType));
  }
}
